...
#define BASE_URL @"http://192.168.1.98:8301"
...
#define SOCKET_SERVER_URL @"ws://192.168.1.21:31052/liveRoom/websocket"
#define SOCKET_SEND_URL(liveId) COMBINE_STRINGS(@"/formApp/student/accept.", liveId)
#define SOCKET_SUBSCRIBE_URL(channelId) COMBINE_STRINGS(@"/topic/222.", channelId)
